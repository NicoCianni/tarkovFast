...
const Traders = ({navigation}) => {
    return (
        <ScrollView style={styles.back}>
            ...
            <TouchableOpacity style={styles.trader} onPress={() => navigation.navigate("TraderStack", {screen: "Therapist"})}>
            ...
            <TouchableOpacity style={styles.trader} onPress={() => navigation.navigate("TraderStack", {screen: "Fence"})}>
            ...
            <TouchableOpacity style={styles.trader} onPress={() => navigation.navigate("TraderStack", {screen: "Skier"})}>
            ...
            <TouchableOpacity style={styles.trader} onPress={() => navigation.navigate("TraderStack", {screen: "Peacekeeper"})}>
            ...
            <TouchableOpacity style={styles.trader} onPress={() => navigation.navigate("TraderStack", {screen: "Ragman"})}>
            ...
            <TouchableOpacity style={styles.trader} onPress={() => navigation.navigate("TraderStack", {screen: "Jaeguer"})}>
            ...
            <TouchableOpacity style={styles.trader} onPress={() => navigation.navigate("TraderStack", {screen: "Ref"})}>
